...
def main():
    ...
    root.title("Student Center") #set title to Student Center
    root.configure(bg='#ADD8E6') #set bg
    ...
    def open_file1():
        open_file("productivitymenu.py") #create a function that opens the productivity menu, used in the button command

    def open_file2():
        open_file("gamemenu.py")

    def open_file3():
        open_file("resources.py")
